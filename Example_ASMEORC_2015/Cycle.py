...
########################################################################              
    ...
    def BaselineTs(self,Inputs,**kwargs):
        ...
        ax.plot(s_exp,T_exp,'ko-',linewidth=2,markersize = 7,markerfacecolor="blue", markeredgewidth=2, markeredgecolor="black")
        ...
        ax.plot(s_exp_s[1],T_exp_s[1],'ko-',linewidth=2,markersize = 7,markerfacecolor="blue", markeredgewidth=2, markeredgecolor="black")
        ...
        ax.plot(r_[s_cond[0],s_cond[-1]],r_[T_cond[0],T_cond[-1]],'ko',markersize = 7,markerfacecolor="blue", markeredgewidth=2, markeredgecolor="black")
        ...
        ax.plot([self.Pump.s_in,self.Pump.s_in],[self.Pump.Tin+273.15,self.Pump.Tout_s],'ko--',linewidth=2,markersize = 7,markerfacecolor="blue", markeredgewidth=2, markeredgecolor="black")
        ax.plot([self.Pump.s_in,self.Pump.s_out],[self.Pump.Tout_s,self.Pump.Tout],'ko--',linewidth=2,markersize = 7,markerfacecolor="blue", markeredgewidth=2, markeredgecolor="black")
        ax.plot(s_pump[0],T_pump[0],'bo',markersize = 7,markerfacecolor="blue", markeredgewidth=2, markeredgecolor="black")
        ax.plot(s_pump[1],T_pump[1],'bo',markersize = 7,markerfacecolor="blue", markeredgewidth=2, markeredgecolor="black")
        ...
        ax.plot(s_evap_zone1[1],T_evap_zone1[1],'ko',markersize = 7,markerfacecolor="blue", markeredgewidth=2, markeredgecolor="black")
        ...
        ax.plot(s_evap_zone2[1],T_evap_zone2[1],'ko',markersize = 7,markerfacecolor="blue", markeredgewidth=2, markeredgecolor="black")
        ...
        ax.plot(s_regen_out,T_regen_out,'bo',markersize = 7,markerfacecolor="red", markeredgewidth=2, markeredgecolor="black")
